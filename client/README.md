## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `Todo`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the Todo API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | Todo                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | todo                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | TodoConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | TodoRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| Todo.Client    | use the "dispatch" functions to send requests       |
| Todo.Core      | core functions, config and request types            |
| Todo.API       | construct api requests                              |
| Todo.Model     | describes api models                                |
| Todo.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| Todo.ModelLens | lenses for model fields                             |
| Todo.Logging   | logging functions and utils                         |
