...
instance Arbitrary CreateTodoRequest where
  arbitrary = sized genCreateTodoRequest

genCreateTodoRequest :: Int -> Gen CreateTodoRequest
genCreateTodoRequest n =
  CreateTodoRequest
    <$> arbitrary -- createTodoRequestTitle :: Text
    <*> arbitraryReducedMaybe n -- createTodoRequestDescription :: Maybe Text
    <*> arbitraryReducedMaybe n -- createTodoRequestDueDate :: Maybe Date
...
genCreateUserRequest n =
  CreateUserRequest
    <$> arbitrary -- createUserRequestName :: Text
  
instance Arbitrary Todo where
  arbitrary = sized genTodo
