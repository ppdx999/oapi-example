...
-- | display the config
instance P.Show TodoConfig where
  show c =
    T.printf
...
-- | constructs a default TodoConfig
--
-- configHost:
--
-- @http://localhost:9995/api/v1@
--
-- configUserAgent:
--
-- @"todo/0.1.0.0"@
--
newConfig :: IO TodoConfig
newConfig = do
    logCxt <- initLogContext
    return $ TodoConfig
        { configHost = "http://localhost:9995/api/v1"
        , configUserAgent = "todo/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => TodoConfig -> auth -> TodoConfig
addAuthMethod config@TodoConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: TodoConfig -> IO TodoConfig
...
withStderrLogging :: TodoConfig -> IO TodoConfig
...
withNoLogging :: TodoConfig -> TodoConfig
...
data TodoRequest req contentType res accept = TodoRequest
  { rMethod  :: NH.Method   -- ^ Method of TodoRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of TodoRequest
  , rParams   :: Params -- ^ params of TodoRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (TodoRequest req contentType res accept) NH.Method
rMethodL f TodoRequest{..} = (\rMethod -> TodoRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (TodoRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f TodoRequest{..} = (\rUrlPath -> TodoRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (TodoRequest req contentType res accept) Params
rParamsL f TodoRequest{..} = (\rParams -> TodoRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (TodoRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f TodoRequest{..} = (\rAuthTypes -> TodoRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => TodoRequest req contentType res accept -> param -> TodoRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: TodoRequest req contentType res accept -> param -> TodoRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: TodoRequest req contentType res accept -> param -> TodoRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
_mkRequest :: NH.Method -- ^ Method
          ...
          -> TodoRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = TodoRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader ::
     TodoRequest req contentType res accept
  -> [NH.Header]
  -> TodoRequest req contentType res accept
...
removeHeader :: TodoRequest req contentType res accept -> [NH.HeaderName] -> TodoRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => TodoRequest req contentType res accept -> TodoRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => TodoRequest req contentType res accept -> TodoRequest req contentType res accept
...
addForm :: TodoRequest req contentType res accept -> WH.Form -> TodoRequest req contentType res accept
addForm req newform =
...
_addMultiFormPart :: TodoRequest req contentType res accept -> NH.Part -> TodoRequest req contentType res accept
...
_setBodyBS :: TodoRequest req contentType res accept -> B.ByteString -> TodoRequest req contentType res accept
_setBodyBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: TodoRequest req contentType res accept -> BL.ByteString -> TodoRequest req contentType res accept
_setBodyLBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => TodoRequest req contentType res accept -> P.Proxy authMethod -> TodoRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    ...
    -> a
    -> TodoRequest req contentType res accept
    -> IO (TodoRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> TodoConfig
  -> IO (TodoRequest req contentType res accept)
_applyAuthMethods req config@(TodoConfig {configAuthMethods = as}) =
  foldlM go req as
  where
